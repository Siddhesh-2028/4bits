...
app = FastAPI(title="VITA-Care API", description="Voice-Integrated Task-Autonomous Care Coordination Agent")
...
async def chat_endpoint(request: ChatRequest):
    ...
    if not os.environ.get("GEMINI_API_KEY"):
        ...
        return ChatResponse(
            response="[MOCK] I received your message: " + request.message + ". (Please set GEMINI_API_KEY for real AI)",
